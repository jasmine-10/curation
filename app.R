    ...
    sidebarPanel(
      ...
      conditionalPanel(condition="input.tabselected==2",
                       ...
                       selectInput("platform",
                                   label="Platform:",
                                   choices=c("All", as.character(unique(fulldata$Platform))),
                                   selected="All",
                                   multiple=TRUE),
                       #input tissue type
                       selectInput("tissue",
                                   label="Tissue type:",
                                   choices=c("All", as.character(unique(fulldata$Tissue))),
                                   selected="All",
                                   multiple=TRUE),
                       #input infection source
                       selectInput("infection",
                                   label="Infection source:",
                                   choices=c("All", as.character(unique(fulldata$Infection))),
                                   selected="All",
                                   multiple=TRUE),
                       #input case condition
                       selectInput("case",
                                   label="Case condition:",
                                   choices=c("All", as.character(unique(fulldata$Case_Condition))),
                                   selected="All",
                                   multiple=TRUE),
                       #input control condition
                       selectInput("control",
                                   label="Control condition:",
                                   choices=c("All", as.character(unique(fulldata$Control_Condition))),
                                   selected="All",
                                   multiple=TRUE),
                       #input age group
                       selectInput("age",
